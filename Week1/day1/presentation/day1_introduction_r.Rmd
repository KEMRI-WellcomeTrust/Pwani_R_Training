...
- Load the package to the environment using library("name package")
...
## Reading Dataset
![RSTUDIO](images/read_datasets.png)
- *Source: Computing for Data Analysis-Roger Peng*

***
 - Create the folder structure
 - Upload the data *birthweight2.csv*
 - read.csv the data with object name birthweight


***
 - Upload the data *bwmal.dta*
 - call package foreign
 - read.dta the data with object name birthweight2
