# Here we will have the solutions to the exercise for the Logistic Regresion
   
onchall <- read.csv("onchall.csv")
...
# Practical 1
ond15p <- read.csv("ond15p.csv")           # read in the data from the stata csv file
